...
const Header = ({ isEnglish, onToggleLang, onGoHome, isDarkMode, onToggleTheme }) => {
  return (
    <header className="top-header">
      ...
      {/* 1. Left: Theme Toggle */}
      <div className="theme-toggle" style={{ position: 'absolute', left: '15px', top: '22px' }}>
      ...
      <div className="logo" onClick={onGoHome} style={{cursor: 'pointer'}}>
        ...
        <div className="header-info">
          ...
          <p className="phone" style={{ flexWrap: 'wrap', justifyContent: 'center' }}>
            ...
            <a href="tel:07866668029" onClick={(e) => e.stopPropagation()}>
              <i className="fa-solid fa-phone"></i> 07866668029
            </a>
          </p>
