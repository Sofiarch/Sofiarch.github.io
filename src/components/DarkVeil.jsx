...
export default function DarkVeil({
  ...
  useEffect(() => {
    ...
    // Safety: Default to window size if parent has no width yet
    ...
    return () => {
      ...
      // REMOVED: gl.getExtension('WEBGL_lose_context').loseContext();
      // This allows the canvas to be reused immediately in Strict Mode.
    };
  }, []);
  ...
  return (
    <div 
      ref={containerRef} 
      className={`relative overflow-hidden ${fullScreen ? 'fixed inset-0 w-full h-full z-0' : 'w-full h-full min-h-[400px]'}`}
    >
