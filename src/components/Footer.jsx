    ...
    <footer className="bg-black border-t border-white/10 pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            <h3 className="font-display text-white font-bold mb-6">Explore</h3>
            <ul className="space-y-4 text-sm text-gray-400">
              ...
              <li>
                <a href="#contact" className="hover:text-blue-500 transition-colors duration-200">Start a Project</a>
              </li>
            </ul>
          </div>

          {/* Column 3: Contact Info (Placeholders) */}
          <div>
            <h3 className="font-display text-white font-bold mb-6">Contact</h3>
            <ul className="space-y-4 text-sm text-gray-400">
              <li>
                <span className="block text-white mb-1 font-medium">Email</span>
                <a href="mailto:hello@linex.com" className="hover:text-blue-500 transition-colors">
                  hello@linex.com
                </a>
              </li>
              <li>
                <span className="block text-white mb-1 font-medium">Phone</span>
                <a href="tel:+9640000000000" className="hover:text-blue-500 transition-colors">
                  +964 000 000 0000
                </a>
              </li>
              <li>
          ...
          <div>
            <h3 className="font-display text-white font-bold mb-6">Legal</h3>
            <ul className="space-y-4 text-sm text-gray-400">
              <li>
              ...
              <li>
                <a href="#" className="hover:text-blue-500 transition-colors duration-200">Cookie Policy</a>
              </li>
            </ul>
          </div>
        </div>
